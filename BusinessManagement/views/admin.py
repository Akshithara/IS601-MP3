...
def importCSV():
    if request.method == "POST":
        ...
        if file.filename[-4:] != '.csv':
            flash('Please upload only .csv files', "warning")
            return redirect(request.url)
        ...
        if file and secure_filename(file.filename):
            ...
            # DONE - TODO importcsv-2 read the csv file stream as a dict
            ...
            for row in reader:
                # pass # todo remove
                print(row) #example
                # DONE - TODO importcsv-3 extract company data and append to company list 
                ...
                # DONE - TODO importcsv-4 extract employee data and append to employee list 
            ...
            if len(companies) > 0:
                ...
                try:
                    ...
                    # DONE - TODO importcsv-5 display flash message about number of companies inserted
                ...
                # DONE - TODO importcsv-6 display flash message (info) that no companies were loaded
            ...
            if len(employees) > 0:
                ...
                try:
                    ...
                    # DONE - TODO importcsv-7 display flash message about number of employees loaded
                 ...
                 # DONE - TODO importcsv-8 display flash message (info) that no employees were loaded
